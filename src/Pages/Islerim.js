...
export default function Islerim () {
  return (
    <div class="flex flex-wrap justify-center items-center h-screen pt-10">
      ...
      <div class="max-w-sm w-full md:w-1/2 p-4">
        <div class="bg-white opacity-80 shadow-lg rounded-lg overflow-hidden h-[420px]">
          ...
          <div class="py-2 px-6 bg-gray-100 flex justify-between ">
            <div className="flex">
              <div>Web Site : </div>
              <a className=" text-blue-700 font-bold" target="_blank" href="https://dataguess-livid.vercel.app"> Link</a>
            </div>
            <div className="flex">
              <div>Git Hub : </div>
              <a className=" text-blue-700 font-bold" target="_blank" href="https://github.com/emrgcmnn/dataguess"> Link</a>
            </div>
          </div>
        </div>
        </div>
